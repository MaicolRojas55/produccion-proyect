...
async def publish_event(event_type: str, payload: dict[str, Any]) -> None:
    """
    Publica un evento durable a RabbitMQ.
    Si RabbitMQ no está disponible, falla silenciosamente (no rompe el flujo).
    """
    try:
        ...
        # Resiliencia: el registro/flujo principal no depende de notificaciones.
        return
